            ...
            <Row className="align-items-left">
              <Col>
                <Form.Group className="mb-3" controlId="name">
                  <Form.Label className="d-flex justify-content-start ms-2">Name</Form.Label>
                  <Form.Control type="text" placeholder="Enter your name" />
                </Form.Group>

                <Form.Group className="mb-3" controlId="phone">
                  <Form.Label className="d-flex justify-content-start ms-2">Phone</Form.Label>
                  <Form.Control type="tel"  placeholder="Enter your phone number" />
                </Form.Group>

                <Form.Group className="mb-3" controlId="email">
                  <Form.Label className="d-flex justify-content-start ms-2">Email</Form.Label>
